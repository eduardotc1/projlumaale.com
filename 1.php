<div id="header">
	...
	<div class="subnav">
        ...
        <div class="wrapsubsearch">
			...
			<form id="sTour" action="search.php" method="POST"><!-- ubicacion temporal -->
			<div class="selects">
			...
			<form id="formTour" action="" method="POST">
	            ...
	            <div class="texts">
					...
					-->
					<div class="ui-widget">
						<input id="tour" class="activity" type="text"/>
					</div>
				</div>
	            </div>
				...
				<div class="search">
						...
						-->
					<input type="submit" class="searchbtn" value="Search Now"/>
				</div>
