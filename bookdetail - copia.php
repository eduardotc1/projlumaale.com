...
//include __DIR__ . 'srcdb/storage/oneTour.class.php';
include_once ('srcdb/storage/oneTour.class.php'); 
if (isset($_POST['tour_id'])) {
    $tour_id = !isset($_POST["tour_id"]) || $_POST["tour_id"] == "undefined" ? 0 : $_POST["tour_id"];
	$singletonOneTour = oneTour::singletonOneTour();
	$item = $singletonOneTour->getTour($tour_id);
}
?>
<!DOCTYPE html>
...
<div id="content">
	<div class="wrapcontent">
		...
		<!-- Aqui empieza los datos del tour -->
...
<!-- scripts de lumaale -->
<!-- <script type="text/javascript" src="js/ajax.bookdetail.js"></script> -->
<script type="text/javascript">
/*
var token = "<?php //cho $_SESSION['token'];?>";
var tour_id = '<?php //echo $tour_id;?>';
*/

//var $loader = $('#right').html("<center><img src='images/bx_loader.gif'/><center>");

//var $loader = $('#right').append("img src='images/679x382.gif' data-thumb='images/100x85.gif' alt='' />");
/*
$(document).ready(function() {
	$.post("srcdb/tour/getTour.php", {token:token, tour_id:tour_id}, function(data,status){
	//alert("Data: " + data + "\nStatus: " + status);
		var $loader = $('#right').html("<center><img src='images/bx_loader.gif'/><center>");
    }).done(function(data) {
        //alert("correcto");
        ...
        console.log("completado, o bien o mal, da lo mismo");
    });
});
*/
